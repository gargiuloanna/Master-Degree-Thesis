...
if __name__ == "__main__":
    ...
    name = "svm/SVM_GS_FallRisk"

    train, test, labeltrain, labeltest, _ = preprocess()


    print("[SVC] Searching best params with GridSearchCV")
    ...
    file = open("C:/Users/annin/PycharmProjects/Master-Degree-Thesis/Code/results/logs/svm/svmGS_fallrisk.txt", "a")
